...
def build_mlp(
    ...
    with tf.variable_scope(scope):
       #Implement layer 1
       output_layer_1=tf.layers.dense(input_placeholder,size,activation,use_bias=True,trainable=True)
       #Output layer_2
       output=tf.layers.dense(output_layer_1,output_size,output_activation,use_bias=True,trainable=True)
...
def main():
    ...
    parser.add_argument('--render', action='store_true',default='store_true')
    parser.add_argument('--discount', type=float, default=1.0)
    parser.add_argument('--n_iter', '-n', type=int, default=100)
    parser.add_argument('--batch_size', '-b', type=int, default=1000)
    parser.add_argument('--ep_len', '-ep', type=float, default=-1.)
    parser.add_argument('--learning_rate', '-lr', type=float, default=5e-3)
    parser.add_argument('--reward_to_go', '-rtg', action='store_true', default='store_true')
    parser.add_argument('--dont_normalize_advantages', '-dna', action='store_true', default='store_true')
    parser.add_argument('--nn_baseline', '-bl', action='store_true', default='store_true')
